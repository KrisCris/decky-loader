...
curl -L https://raw.githubusercontent.com/KrisCris/decky-loader/main/dist/plugin_loader-release.service  --output ${HOMEBREW_FOLDER}/services/plugin_loader-release.service
